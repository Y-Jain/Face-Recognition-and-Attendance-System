...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        title_lbl1 = Button(bg_img,text="STUDENT DETAILS",font = ("times new roman",10,"bold"),bg="darkblue",fg="lightblue",cursor="hand2")
...
# detect face
        ...
        title_lbl2 = Button(bg_img,text="FACE RECOGNITION",font = ("times new roman",10,"bold"),bg="darkblue",fg="lightblue",cursor="hand2")
...
# help
        ...
        title_lbl5 = Button(bg_img,text="TRAIN DATA",font = ("times new roman",10,"bold"),bg="darkblue",fg="lightblue",cursor="hand2")
